...
//dave payload variables
 ...
 wait  = false
  ...
  Save_Form1(post:any){
    ...
    let payload  =  {
      "name":this.patient_payload["name"],
      "surname":this.patient_payload["surname"],
      "email":this.patient_payload["email"],
      "id_number":post.id_number,
      "phone_number":this.patient_payload["phone_number"],
      "title":post.title,
  ...
  Save_Form3(post:any){
    ...
    if(post.agreement == true){
      ...
      this.gen.Complete_patient_profile(payload)
      .subscribe(
        (data)=>{
